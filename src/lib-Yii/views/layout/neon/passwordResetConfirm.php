                        ...
                        <form method="post">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <?= $form->passwordField($model, "newPassword", array("placeholder" => "New Password", 'size' => 60, 'maxlength' => 128, "class" => "form-control")) ?>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <?= $form->passwordField($model, "passwordConfirm", array("placeholder" => "Password Confirm", 'size' => 60, 'maxlength' => 128, "class" => "form-control")) ?>
